...
```
Episodes terminate when the agent stagnates (3 flat steps) or `step >= max_steps`.
...
# HF_TOKEN=hf_...          (Hugging Face token - hackathon standard)
# API_BASE_URL=https://router.huggingface.co/v1
# MODEL_NAME=Qwen/Qwen2.5-7B-Instruct
#
# OR for local OpenAI testing:
# OPENAI_API_KEY=sk-...
```

### 3. Run Inference (Hackathon Format)

```bash
python inference.py
# Outputs strict [START] / [STEP] / [END] lines for automated evaluation
```
...
-- Episode 1/7 | factual_qa --
  ...
  [OK] Done | final=0.720 delta=+0.670 | steps=2
...
============================================================
  RESULTS SUMMARY
  Avg init score:  0.0621
  Avg final score: 0.7340
  Avg delta score: +0.6719
============================================================
```
...
| `OPENAI_API_KEY` | Yes (local) | OpenAI key for local testing (fallback) |
