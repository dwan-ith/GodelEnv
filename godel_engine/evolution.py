"""
Core Gödel Engine Logic — Darwin and Huxley evolutionary layers.
Lives in the godel_engine package so it can be used without a web server.
"""
...
class DarwinPool:
    """Tournament-based strategy population."""
    ...
    def select(self) -> Strategy:
        ...
        return max(candidates, key=lambda s: s.fitness + s.cmp_score)


class HuxleyTracker:
    """Tracks Clade-Metaproductivity (CMP) across generations."""
